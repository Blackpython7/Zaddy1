...
API_URL = getenv("API_URL", 'http://3.0.146.239:1470/youtube') #youtube song url
API_KEY = getenv("badmusic_ytstream_apikey_2025", None) # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz
